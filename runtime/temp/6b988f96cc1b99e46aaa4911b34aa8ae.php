<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\phpStudy\WWW\thinkphp_5.0.9_blog/application/admin\view\article\store.html";i:1498035903;s:68:"D:\phpStudy\WWW\thinkphp_5.0.9_blog/application/admin\view\base.html";i:1498027422;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            <div class="panel panel-default" id="menus">
                ...
                <div class="list-group menus collapse in" id="collapseExample">
                ...
                <div class="list-group menus collapse in" id="collapseExample2">
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    <li><a href="<?php echo url('admin/article/index'); ?>"><i class="fa fa-cogs"></i>文章管理</a></li>
    <li class="active"><a href="javascript:;">文章添加</a></li>
</ol>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="number" name="arc_sort"  class="form-control" value="100" placeholder="文章排序">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="js-example-basic-single form-control" name="cate_id">
                        ...
                        <?php if(is_array($cateDate) || $cateDate instanceof \think\Collection || $cateDate instanceof \think\Paginator): if( count($cateDate)==0 ) : echo "" ;else: foreach($cateDate as $k=>$vo): ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <?php if(is_array($tagDate) || $tagDate instanceof \think\Collection || $tagDate instanceof \think\Paginator): if( count($tagDate)==0 ) : echo "" ;else: foreach($tagDate as $k=>$vo): ?>
