...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    <li>
        <a href="<?php echo url('admin/tag/index'); ?>"><i class="fa fa-cogs"></i>
            标签管理</a>
    </li>
    <li class="active">
        <a href="javascript:;">标签添加</a>
    </li>
</ol>
<ul class="nav nav-tabs" role="tablist">
    <li><a href="<?php echo url('index'); ?>">标签管理</a></li>
    <?php if(input("param.tag_id")): ?>
    <li class="active"><a href="javascript:;">标签编辑</a></li>
    <?php else: ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="tag_name" value="<?php echo $oldDate['tag_name']; ?>">
                </div>
            </div>
        </div>
    </div>
