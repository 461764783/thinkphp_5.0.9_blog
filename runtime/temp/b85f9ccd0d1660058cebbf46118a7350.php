<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpStudy\WWW\thinkphp_5.0.9_blog/app/admin\view\article\recycle.html";i:1498120245;s:60:"D:\phpStudy\WWW\thinkphp_5.0.9_blog/app/admin\view\base.html";i:1498182309;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="arc_sort" onblur="changeSort(this,<?php echo $vo['arc_id']; ?>)" value="<?php echo $vo['arc_sort']; ?>">
                    </td>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class="divider"></li>
                                <li><a href="javascript:;" onclick="del(<?php echo $vo['arc_id']; ?>);">删除数据</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
...
<script>
    ...
    function del(arc_id){
        util.confirm('确定删除吗?',function(){
            $.get("<?php echo url('del'); ?>",{'arc_id':arc_id},function(res){
                if(res.code){
